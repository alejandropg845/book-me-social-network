...
namespace BookMeServer.Interfaces.Repositories.Notifications
{
    public interface INotificationsWriteRepository
    {
        ...
        Task<int> AddAcceptedFollowRequestDataAsync(SqlConnection connection, IDbTransaction transaction, string userReceiverId, string userSenderId, Guid chatId);
        Task<int> SendFollowRequestAsync(SqlConnection connection, string userSenderId, string userReceiverId);
        Task<int> SetAcceptedResponseFRDataAsync(SqlConnection connection, IDbTransaction transaction, string userSenderId, string userReceiverId, Guid chatId);
    }
}
